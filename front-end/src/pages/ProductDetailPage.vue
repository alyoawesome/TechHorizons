<template>
    <div v-if="product">
        ...
        <div class="product-details">
          ...
          <button class="grey-button add-to-cart" v-if="user && itemIsInCart">Item Already in Cart</button>
  ...
  export default {
    ...
    methods: {
      ...
      async signIn() {
        ...
        const actionCodeSettings = {
          url: `https://techhorizons.onrender.com/products/${this.$route.params.productId}`,
    ...
    components: {
      ...
      if (isSignInWithEmailLink(auth, window.location.href/*If current window url contains the auth info created by firebase link*/)){
